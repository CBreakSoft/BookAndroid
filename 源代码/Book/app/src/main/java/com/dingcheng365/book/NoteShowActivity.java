...
public class NoteShowActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //列表项id
        int[] to={R.id.ns_tv_bookID};
        //列表视图
        final ListView listView=(ListView) findViewById(R.id.ns_list);
        //适配器
        SimpleCursorAdapter adapter=new SimpleCursorAdapter(this,R.layout.note_show_layout,c,from,to,0);//this,R.layout.display_layout,c,from,to
        //为列表添加适配器
            ...
            public void onItemClick(final AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                switch(arg0.getId())
                {
                    case R.id.ns_list:
                        ...
                        TextView mytextview = (TextView) mView.findViewById(R.id.ns_tv_bookID);
